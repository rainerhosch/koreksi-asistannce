...
<div class="position-relative">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner py-6 mx-4">
                ...
                <div class="card p-7">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="index.html" class="app-brand-link gap-3">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">Koreksi Soal App</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    ...
                    <div class="card-body mt-1">
                        ...
                        <form id="formAuthentication" class="mb-5" action="<?= base_url('auth/login_process')?>" method="POST">
                ...
                <!-- /Login -->
                <img src="<?= base_url() ?>assets/img/illustrations/tree-3.png" alt="auth-tree"
                    class="authentication-image-object-left d-none d-lg-block" />
                <img src="<?= base_url() ?>assets/img/illustrations/auth-basic-mask-light.png"
                    class="authentication-image d-none d-lg-block" height="172" alt="triangle-bg"
                    data-app-light-img="illustrations/auth-basic-mask-light.png"
                    data-app-dark-img="illustrations/auth-basic-mask-dark.png" />
                <img src="<?= base_url() ?>assets/img/illustrations/tree.png" alt="auth-tree"
